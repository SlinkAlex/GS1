class Tarifa < ActiveRecord::Base
  ...
  validates_numericality_of :desde, :message =>" - Es un campo numerico"
  validates_numericality_of :hasta, :message =>" - Es un campo numerico"
  validates_numericality_of :aporte_bs, :message =>" - Debe ingresar un monto"
